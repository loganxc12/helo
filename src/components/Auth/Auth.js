          ...
          return (
               <div className="auth">
                    <div className="login-box">
                         ...
                         <h1>Helo</h1>
                         <p>Username:</p><input name="username" value={username} onChange={this.handleInputChange} />
                         <p>Password:</p><input name="password" value={password} onChange={this.handleInputChange} />
                         <button>Login</button>
